...
base= ggplot(data=namedata2, aes(x= cum_prop100k, y = count)) 
...
#what you see - as names get rarer, the share of all people accounted for so far rises, but at a decreasing rate

#fix up the base object; choose something other than cum_prop100k
