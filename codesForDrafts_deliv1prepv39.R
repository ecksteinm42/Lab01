...
del1Draft3 = del1Draft3 +  theme_minimal() + theme(axis.text.x = element_text(angle = 90), panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + labs(title = "10 Most Common Surnames", x = "Surname", y = "Number of Occurrences", subtitle = "United States, 2010", caption = "Source: 2010 US Census") + theme(plot.title = element_text(size = 13))
del1Draft3
