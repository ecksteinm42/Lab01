...
del2Draft2= base2 + geom_histogram(binwidth = 5, aes(x=pctblack)) + labs(title = "Distribution of Common Surnames", x = "Percent Black", y = "Number within Top 10 Names") + scale_x_continuous(breaks = seq(0, 60, by = 5)) + theme(plot.title = element_text(size=8.5))
del2Draft2
