...
del2Draft2= base2 + geom_histogram(binwidth = 5, aes(x=reorder(prop100k, -prop100k))) + labs(title = "Proportion per 100,000 People of Each of the Top 10 USA Surnames", x = "fill", y = "fill") + scale_x_continuous(breaks = seq(0, 60, by = 5)) + theme(plot.title = element_text(size=8.5))
del2Draft2
