...
#try a barplot of pctwhite colored by pctblack?

base3= ggplot(data=namedata2) 
del3draft2= base3 + theme_minimal() + geom_bar(aes(x=pctwhite, fill=pctblackgroup)) + labs(x = "Percent White")
del3draft2

#Or, color by pctblackgroup (have not attempted yet)
