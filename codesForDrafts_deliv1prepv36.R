...
del2Draft2= base2 + geom_histogram(binwidth = 5, aes(x= length)) + labs(title = "Distribution of Common Surnames", x = "Proportion per 100,000", y = "Number within Top 10 Names") + theme(plot.title = element_text(size=10)) +  annotate(geom = 'text', size = 2.75, label = note, y = -0.1, x = 600, angle = 0)
del2Draft2
