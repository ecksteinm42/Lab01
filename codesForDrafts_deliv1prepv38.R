...
del2Draft3= base2 + geom_histogram(binwidth = 1, aes(x= length)) + labs(title = "Number of Letters in Common Surnames", x = "Number of Letters in Name", y = "Number of Names") + theme(plot.title = element_text(size=10)) +  annotate(geom = 'text', size = 2.75, label = note, y = -0.01, x = 10, angle = 0)
del2Draft3
