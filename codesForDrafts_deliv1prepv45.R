...
base5= ggplot(data = namedata3)
del3draft12= base5 + theme_minimal() + geom_point(aes(x=pctwhite, y=pct2prace)) + labs(x = "Percent White", y = "Percent Two or More Races") + annotate(geom = 'text', size = 2.75, label = note, y = -0.1, x = 7, angle = 0)
del3draft12
#NOTE: FIX THIS ANNOTATION! What I want is not what came out but rather name labels. Consider labeling a few names, Magallanes suggested
