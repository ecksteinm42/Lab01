...
del2Draft2= base2 + geom_histogram(binwidth = 5, aes(x= prop100k)) + labs(title = "Distribution of Common Surnames", x = "Proportion per 100,000", y = "Number within Top 10 Names") + theme(plot.title = element_text(size=8.5)) + scale_x_reverse() + scale_y_continuous(position = "right")
del2Draft2
